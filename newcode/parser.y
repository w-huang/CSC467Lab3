 ...
 * /Users/sriram/Downloads/compilers (1)/parser.y
  ...
  | type ID '=' expression ';'
      {
          ...
          $$ = ast_allocate(ASSIGNMENT_DECLARATION_NODE,$1,$2,$4);
      }
  | CONST type ID '=' expression ';'
      {
          yTRACE("declaration -> CONST type ID = expression ;\n")
          $$ = ast_allocate(CONST_ASSIGNMENT_NODE,$2,$3,$5);
      }
  ;
  ...
  | scope
      {
          ...
          $$ = ast_allocate(STATEMENT_SCOPE_NODE,$1);
      }
  | ';'
      {
          yTRACE("statement -> ; \n")
  ...
  | expression LEQ expression %prec LEQ
      {
          ...
          $$ = ast_allocate(BINARY_EXPRESSION_NODE,$1,$3,LEQ);
      }
  | expression '>' expression %prec '>'
      {
          yTRACE("expression -> expression > expression \n")
  ...
  | expression GEQ expression %prec GEQ
      {
          ...
          $$ = ast_allocate(BINARY_EXPRESSION_NODE,$1,$3,GEQ);
      }
  | expression '+' expression %prec '+'
      {
          yTRACE("expression -> expression + expression \n")
  ...
  | variable 
    {
        ...
        $$ = ast_allocate(EXPRESSION_VAR_NODE,$1);
    }
  ;
  ...
  | ID '[' INT_C ']' %prec '['
      {
          ...
          $$ = ast_allocate(INDEXING_NODE,$1,$3);
      }
  ;
